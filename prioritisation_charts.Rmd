...
chart_data <- import_chart_data("alpha-fact/prioritisation_charts/SR Option Template part B collator v14.xlsm",
                                shortlist = NULL)
...
To illustrate: In the top-right square of the grid, you have two options, PPS025, PPS026 and PPS027, which are highly impactful and deliverable. They are also quite strongly strategically aligned, and have OK evidence to back them up. However, they are all expensive options.

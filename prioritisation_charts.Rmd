...
# This sets global options for chunks of R code, to set a standard plot size and suppress output of code and warnings.
...
chart_data <- s3tools::read_using(readxl::read_excel,
                                 ...
                                 skip = 6) %>%
  rename_and_filter_data() %>% # this function has an optional "shortlist" parameter, which should be a vector of option references. If included, the data will be filtered to just those options.

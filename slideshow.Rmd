...
subtitle: The charts in this slide pack provide an analysis of the 104 options in the “Take forward” list
...
The following charts show how the `r nrow(chart_data)` options in the “take forward list” are distributed under each of the five scorecard criteria:
...
The following charts show how the `r nrow(chart_data)` options in the “take forward list” are distributed under a further two criteria:
...
The following chart shows only those `r nrow(chart_data)` options that are categorised as “likely to save” and have therefore automatically been included on the “take forward” list:
...
The following chart shows all `r nrow(chart_data)` options in the “take forward” plotted against all five criteria used to inform the scorecard, and a further criteria assessing the quality of the financial impacts:
